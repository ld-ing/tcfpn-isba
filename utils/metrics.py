...
# Li Ding
# Mar. 2018
# Modified from https://github.com/colincsl/TemporalConvolutionalNetworks/blob/master/code/metrics.py
...
class ComputeMetrics:
    metric_types = ["accuracy", "accuracy_wo_bg", "overlap_score", "IoD"]
    # "edit_score", "overlap_f1","overlap_f1_.25","overlap_f1_.5"]
    ...
    def __init__(self, metric_types=None, overlap=.1, bg_class=None, n_classes=None):
        ...
        self.attrs = {"overlap": .1, "bg_class": bg_class, "n_classes": n_classes}
        self.trials = []
...
def classification_accuracy(P, Y, bg_class=None, **kwargs):
    ...
    # P can either be a set of prediction (1d) or scores (2d)
